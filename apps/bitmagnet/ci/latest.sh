...
version=$(curl -L -sX GET 'https://api.github.com/repos/bitmagnet-io/bitmagnet/releases?per_page=1' --header "Authorization: Bearer ${TOKEN}" | jq --raw-output '.[0].tag_name')
